...
import com.example.SpaceSurfing.ChangeVisibilityActivity;
...
import com.example.SpaceSurfing.adapters.MatchAdapter;
import com.example.SpaceSurfing.dialogs.MatchDialogFive;
import com.example.SpaceSurfing.dialogs.MatchDialogFour;
import com.example.SpaceSurfing.dialogs.MatchDialogOne;
import com.example.SpaceSurfing.dialogs.MatchDialogSix;
import com.example.SpaceSurfing.dialogs.MatchDialogThree;
import com.example.SpaceSurfing.dialogs.MatchDialogTwo;
...
public class MatchFragment extends Fragment implements MatchDialogOne.PageOneListener,
    ...
    private void launchMatchingDialog() {
        new AlertDialog.Builder(getContext())
                .setIcon(R.drawable.ic_baseline_person_black_24)
                .setTitle("Hi!")
                .setMessage("Proceed?")
